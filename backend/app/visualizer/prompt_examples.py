...
FEW_SHOT_EXAMPLES: list[dict] = [
    # ───── Mega-cap 5 (実利用上位) ─────
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "収益構成", "question": "サービス売上比率 25% 超を維持できるか。"},
                {"angle": "事業依存", "question": "ハードウェア依存度を下げられるか。"},
                {"angle": "マクロ", "question": "中華圏需要の回復タイミングをどう読むか。"},
            ],
    ...
    },
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "集中度", "question": "Data Center 集中度 87% の景気循環リスクをどう見るか。"},
                {"angle": "成長持続", "question": "Blackwell 量産で需要捕捉を継続できるか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
    ...
    },
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "収益性", "question": "EV 価格競争下で営業マージン 10% 台を取り戻せるか。"},
                {"angle": "成長源", "question": "FSD / Energy の収益貢献は加速するか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
    ...
    },
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "資本効率", "question": "AI capex $80B の ROI を Azure 成長で正当化できるか。"},
                {"angle": "収益化", "question": "Copilot 収益化のスピードをどう見るか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
    ...
    },
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "収益性", "question": "Reality Labs 赤字を広告キャッシュフローで吸収できるか。"},
                {"angle": "投資継続", "question": "AI 投資を継続できるキャッシュフロー余力があるか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
    ...
    # ───── 業種代表 3 ─────
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "会員基盤", "question": "会員更新率 92.9% を維持できるか。"},
                {"angle": "価格戦略", "question": "会費値上げを会員離れなく実施できるか。"},
                {"angle": "既存店", "question": "既存店成長率をどう維持するか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
    ...
    },
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "金利感応", "question": "金利低下で純利息マージン圧迫をどう見るか。"},
                {"angle": "収益分散", "question": "投資銀行 / 資産管理が利息収益を補えるか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
    ...
    },
    {
        ...
        "output_json": {
            ...
            "investorQuestions": [
                {"angle": "マクロ", "question": "原油 $70/bbl 前後で営業キャッシュフローを維持できるか。"},
                {"angle": "株主還元", "question": "配当 + 自社株買いを継続できるか。"},
            ],
            "consensusSource": "FactSet via FMP analyst-estimates",
