...
- get_system_blocks の 2 break point cache 構造
"""
...
def test_get_system_blocks_two_blocks_with_cache():
    """multi-review verdict: 2 break points (instructions + examples+negatives)、 残 2 個は Phase 5+ 温存."""
