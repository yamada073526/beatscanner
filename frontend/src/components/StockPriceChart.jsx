...
// v147 (user dogfood NVDA「破線が分かりづらい」 + 2 体合議): cup 破線/dot を slate-400→slate-300 に明色化。
//   ダーク背景に対し輝度比 ~5.5:1 (WCAG AA)、 方向を示さない中立色は維持 (緑/赤/amber/cyan/purple は予約済)。
const CUP_LINE_COLOR = '#cbd5e1'; // slate-300 (cup 破線/dot stroke、 視認性向上)
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                */}
                ...
                {/* MVP #3: cup 輪郭の破線 (v147 視認性改善、 2 体合議):
                    - slate-300 明色 / 線幅 1.5 / 長 dash "8 5" (SMA の短実線と文法差別化) / opacity 0.85
                    - dot を r3.5 + 明色 stroke で 4 点 (rim/低/rim/handle) のアンカーを明確化
                ...
                {hasCup && !cupRequiresPro && (
                  <Line
                    ...
                    strokeWidth={cupHandle.state === 'breakout_confirmed' ? 2 : 1.5}
                    strokeDasharray={cupHandle.state === 'breakout_confirmed' ? null : '8 5'}
                    strokeOpacity={cupHandle.state === 'formation_market_weak' ? 0.55 : 0.85}
                    dot={{ r: 3.5, fill: CUP_COLOR, stroke: CUP_LINE_COLOR, strokeWidth: 1, fillOpacity: 1 }}
                    activeDot={false}
                    connectNulls
                    name="取っ手付きカップ"
                    legendType="none"
