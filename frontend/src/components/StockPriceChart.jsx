...
// chart 定数 + 純粋ヘルパ (色 / 期間 / verdict map / 日付・format / 非株式判定 / flag) は stockChartUtils.js へ抽出。
import {
  BREAKOUT_COLOR,
  CHART_AXIS,
  CHART_CURSOR,
  ...
  quarterLabel,
  surpriseLabel,
} from './stockChartUtils.js';

// 後方互換: PriceLadder が import する SMA 色を再 export (consumer の import 元維持)。
export { SMA_50_COLOR, SMA_200_COLOR };
