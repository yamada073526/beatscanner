...
export const SELL_ZONE_DESC_JP = {
  ...
  stop_hit: '過去最高値から -8% (Chandelier Exit 方式) の参考レベル。 IBD/O\'Neil 著の universal stop loss (購入価格から -8%) とは別の指標で、 保有銘柄の利確検討の補助として参考表示しています (Phase 2 で portfolio integration 予定)。',
