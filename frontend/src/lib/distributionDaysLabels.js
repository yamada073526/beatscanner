...
export const DIST_DAYS_DESC_JP = {
  healthy: {
    ...
    detail: '直近25営業日の distribution day が 0-2 日 (一般的なルールの健全圏目安)。',
  },
  caution: {
    conclusion: '機関の売り圧力が増えつつある目安です。',
    detail: 'distribution day 3-4 日は一般的なルールで注意の目安とされます。',
  },
  pressure: {
    conclusion: '機関の売り圧力が高い目安です (将来保証なし)。',
    detail: 'distribution day 5 日以上は一般的なルールで market/銘柄が under pressure とされる目安に該当。',
  },
  unknown: {
