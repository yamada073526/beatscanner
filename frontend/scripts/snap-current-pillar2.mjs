...
// 使い方: cd frontend && node scripts/snap-current-pillar2.mjs
// 出力: frontend/.visual/current-pillar2/{pane1,pane3,pane4}.png
//
// CLAUDE.md visual harness exception 準拠:
//   - headless: true 固定
//   - 60s hard timeout 自動 teardown
//   - 出力は .visual/current-pillar2/ のみ (gitignore 済)
//   - 本番 URL のみ
...
const OUT = resolve('.visual/current-pillar2');
