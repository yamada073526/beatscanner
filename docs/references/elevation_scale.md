...
ALLOWED-HEX: #eef2f7   # --bg-future (light) — 将来ゾーン ガラス仕切り背景 (screener 通信簿 v12)
ALLOWED-HEX: #121a28   # --bg-future (dark) — 将来ゾーン ガラス仕切り背景 (screener 通信簿 v12)
...
# SPEC 2026-06-04 B: Hero ウォッチ★ボタン (.hero-watch-add:hover) — add variant 既定 cyan hover を gold に上書き (selector ベース)
ALLOWED-IMPORTANT: frontend/src/index.css  # button.ds-chip.hero-watch-add:hover border-style (solid 固定)
ALLOWED-IMPORTANT: frontend/src/index.css  # button.ds-chip.hero-watch-add:hover border-color (gold)
ALLOWED-IMPORTANT: frontend/src/index.css  # button.ds-chip.hero-watch-add:hover background (gold tint)
ALLOWED-IMPORTANT: frontend/src/index.css  # button.ds-chip.hero-watch-add:hover color (gold)
ALLOWED-IMPORTANT: frontend/src/index.css  # [data-theme=dark] hero-watch-add:hover border-color (gold, specificity 逆転対策)
ALLOWED-IMPORTANT: frontend/src/index.css  # [data-theme=dark] hero-watch-add:hover background (gold tint)
ALLOWED-IMPORTANT: frontend/src/index.css  # [data-theme=dark] hero-watch-add:hover color (gold)
```
